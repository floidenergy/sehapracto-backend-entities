...
var prescriptions_entity_exports = {};
__export(prescriptions_entity_exports, {
  Prescription: () => Prescription
});
module.exports = __toCommonJS(prescriptions_entity_exports);
...
_ts_decorate4([
  (0, import_typeorm4.ManyToOne)(() => Order, {
    onDelete: "CASCADE"
  }),
...
_ts_decorate4([
  (0, import_typeorm4.OneToOne)(() => Product, {
    onDelete: "CASCADE"
  }),
  (0, import_typeorm4.JoinColumn)({
    name: "product_id"
...
OrderItem = _ts_decorate4([
  (0, import_typeorm4.Entity)("order_items")
], OrderItem);
...
Country = _ts_decorate5([
  (0, import_typeorm5.Entity)("countries")
], Country);
...
_ts_decorate6([
  ...
  _ts_metadata6("design:type", typeof APP_TYPE === "undefined" ? Object : APP_TYPE)
...
_ts_decorate7([
  (0, import_typeorm7.DeleteDateColumn)({
    type: "timestamp"
  }),
  _ts_metadata7("design:type", typeof Date === "undefined" ? Object : Date)
...
Patient = _ts_decorate7([
  (0, import_typeorm7.Entity)("patients")
], Patient);
...
_ts_decorate10([
  (0, import_typeorm10.ManyToOne)(() => Order, {
    onDelete: "SET NULL"
  }),
...
_ts_decorate10([
  (0, import_typeorm10.ManyToOne)(() => Patient, {
    onDelete: "SET NULL"
  }),
  (0, import_typeorm10.JoinColumn)({
    name: "patient_id"
...
_ts_decorate10([
  (0, import_typeorm10.ManyToOne)(() => Attachement, {
    onDelete: "SET NULL"
  }),
  (0, import_typeorm10.JoinColumn)({
    name: "attachement_id"
...
Prescription = _ts_decorate10([
  (0, import_typeorm10.Entity)("prescriptions")
], Prescription);
