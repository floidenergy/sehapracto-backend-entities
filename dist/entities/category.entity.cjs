...
_ts_decorate2([
  ...
  _ts_metadata2("design:type", typeof Category === "undefined" ? Object : Category)
...
Product = _ts_decorate2([
  (0, import_typeorm2.Entity)("products")
], Product);
...
_ts_decorate3([
  (0, import_typeorm3.OneToMany)(() => Product, (product) => product.category),
  _ts_metadata3("design:type", Array)
], Category.prototype, "products", void 0);
Category = _ts_decorate3([
  (0, import_typeorm3.Entity)("categories")
], Category);
