...
var adminPermission_entity_exports = {};
__export(adminPermission_entity_exports, {
  AdminPermission: () => AdminPermission
});
module.exports = __toCommonJS(adminPermission_entity_exports);
...
Country = _ts_decorate3([
  (0, import_typeorm3.Entity)("countries")
], Country);
...
_ts_decorate4([
  (0, import_typeorm4.ManyToOne)(() => Country, {
    nullable: false,
    onDelete: "SET NULL"
  }),
  ...
  _ts_metadata4("design:type", typeof Country === "undefined" ? Object : Country)
...
_ts_decorate5([
  (0, import_typeorm5.OneToOne)(() => Department, {
    onDelete: "SET NULL"
  }),
  (0, import_typeorm5.JoinColumn)({
    name: "department_id"
  }),
  _ts_metadata5("design:type", typeof Department === "undefined" ? Object : Department)
...
_ts_decorate5([
  (0, import_typeorm5.OneToOne)(() => User, {
    onDelete: "CASCADE"
  }),
  (0, import_typeorm5.JoinColumn)({
    name: "user_id"
...
_ts_decorate5([
  (0, import_typeorm5.ManyToMany)(() => AdminPermission, (permission) => permission.admins),
  (0, import_typeorm5.JoinColumn)({
...
_ts_decorate6([
  (0, import_typeorm6.ManyToMany)(() => Admin, (admin) => admin.permissions),
  _ts_metadata6("design:type", Array)
], AdminPermission.prototype, "admins", void 0);
AdminPermission = _ts_decorate6([
  (0, import_typeorm6.Entity)("admin_permissions")
], AdminPermission);
