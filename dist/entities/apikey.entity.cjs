...
var apikey_entity_exports = {};
__export(apikey_entity_exports, {
  ApiKey: () => ApiKey
});
module.exports = __toCommonJS(apikey_entity_exports);
...
_ts_decorate2([
  ...
  _ts_metadata2("design:type", typeof APP_TYPE === "undefined" ? Object : APP_TYPE)
...
ApiKey = _ts_decorate2([
  (0, import_typeorm2.Entity)("api_keys")
], ApiKey);
